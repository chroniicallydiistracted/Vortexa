...
export interface EventInput { seed?: boolean }
...
export const handler = async (_event: EventInput = {}) => {
  ...
  try {
    console.log('[alerts-lambda] putting item', feature.properties.id, 'into table', ALERTS_TABLE);
  ...
  sk: 'v0',
    ...
    return { statusCode: 200, body: JSON.stringify({ ok: true, id: feature.properties.id }) };
  } catch (e: any) {
