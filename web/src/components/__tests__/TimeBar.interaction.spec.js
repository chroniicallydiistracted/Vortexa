...
function Wrapper() {
    ...
    return (_jsx(TimeBar, { playing: false, togglePlay: () => { }, baseStart: base, hoursSpan: hoursSpan, currentTime: cur, setCurrentTime: setCur, currentDate: date, setCurrentDate: setDate, hourValue: hourValue, setHourValue: () => { }, speed: speed, setSpeed: setSpeed }));
}
describe('TimeBar interactions', () => {
    it('mounts and shows iso label', () => {
        const { getByText } = renderWithMantine(_jsx(Wrapper, {}));
